...
class boxplotter(object):
    ...
    def draw_on(self, ax, index, width, box_color = "#348ABD",
                median_color = "#A60628", whisker_color = "black"):
        #width = .7
        #width = 0.5
        w2 = width / 2
